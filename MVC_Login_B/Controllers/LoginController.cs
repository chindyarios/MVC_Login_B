...
namespace MVC_Login_B.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult MasukDash()
        {

            return View();
        }

        public ActionResult CreateDash()
        {
        ...
        [HttpPost]
        public ActionResult MasukDash(ClassLogin login) // yang ijomuda itu nama class 
        {
            var currentAccount = Mycontext.Login.FirstOrDefault(dta => dta.Email == login.Email);
            if (currentAccount != null)
            {
        ...
        // POST: Register/Create
        [HttpPost]
        public async Task<ActionResult> CreateDash(ClassLogin login)
        {
            login.Password = BCrypt.Net.BCrypt.HashPassword(login.Password);
            Mycontext.Login.Add(login);
            Mycontext.SaveChanges(); 
